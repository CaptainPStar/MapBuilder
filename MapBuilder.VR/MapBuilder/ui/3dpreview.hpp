...
//	Infopopup
//###################
 class MB_Window_3DPreview_Group : RscControlsGroup
{
	idc = 171100;
	...
	class Controls
	{
		class MB_Window_3DPreview_BG : Rsc_Background {
			idc = -1;
			text = "";
		...
		class MB_Window_3DPreview_Header : Rsc_Background {
			idc = -1;
			text = "3D Preview";
			style = ST_MULTI;
			x = MB_WINDOW_GRID_X * 0;
		...
		class MB_Window_3DPreview_RTT : RscPicture {
			idc = -1;
